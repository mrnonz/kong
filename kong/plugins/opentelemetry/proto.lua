--- Proto
-- defines the OTLP .proto
local protoc = require "protoc"

-- https://github.com/open-telemetry/opentelemetry-proto/blob/v0.18.0/opentelemetry/proto/common/v1/common.proto
protoc:load([[
  syntax = "proto3";
...
-- https://github.com/open-telemetry/opentelemetry-proto/blob/v0.18.0/opentelemetry/proto/resource/v1/resource.proto
protoc:load([[
  syntax = "proto3";
...
-- https://github.com/open-telemetry/opentelemetry-proto/blob/v0.18.0/opentelemetry/proto/trace/v1/trace.proto
protoc:load([[
  syntax = "proto3";
...
-- https://github.com/open-telemetry/opentelemetry-proto/blob/v0.18.0/opentelemetry/proto/collector/trace/v1/trace_service.proto
protoc:load([[
  syntax = "proto3";
